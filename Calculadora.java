...
public class Calculadora  extends JPanel implements ActionListener {
	...
	JButton adicao, subtracao, multiplicacao, divisao, power,resto,fatorial,espaco,parenteses_esq,parenteses_dir;
	JButton n0,n1,n2,n3,n4,n5,n6,n7,n8,n9;
	JButton igual, apagar, limpar,negativo;
	JButton RPN2;
	JButton ponto;
	ActionEvent e;
	...
	public Calculadora() { 
		...
		this.parenteses_esq=new JButton("(");
		this.parenteses_dir=new JButton(")");
		...
		parenteses_esq.setBackground(Color.WHITE);
		parenteses_dir.setBackground(Color.WHITE);
		...
		this.igual.addActionListener(new ActionListener(){
			...
			public void actionPerformed(ActionEvent e) {
				...
				if(isRPN==1){
					...
					try {
						conta_pow=RPN.avaliacao(conceito_matematica,infixo);
					...
					String pos_fixo[]=RPN.infixo_pra_pos_fixo(infixo);
